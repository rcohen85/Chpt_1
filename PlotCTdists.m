...
dayDir = 'F:\DailyCT_Totals\minClicks50'; % directory containing CT daily totals for each site
matchStr = '_DailyTotals_Prob0_RL120_numClicks50.mat';
errDir = 'F:\ErrorEval'; % directory containing error summary from plot_labCert
seasDir = 'F:\SeasonalCT_Totals\minClicks50'; % directory to save seasonal data
mapDir = 'F:\SeasonalMaps\minClicks50';
...
for iS = 1:size(fileList,1)
    ...
    saveName = fullfile(seasDir,[CT,'_AdjustedSeasonalTotals.mat']);
    ...
    adjSeasonalData = seasonalData;
    save(saveName,'adjSeasonalData','-v7.3');
