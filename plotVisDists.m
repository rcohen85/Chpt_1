...
clf
% subplot(2,2,1)
% subplot('Position',[0.0969 0.48 0.25 0.444]);
...
[~, objH] = legend([c,b],label1,label2,'Position',[0.28 0.6 0.08 0.033]);
set(findobj(objH(5)),'Vis','off');
pos = get(objH(2), 'Pos');
set(objH(2), 'Pos', [0.08 pos(2:3)]);
...
[~, objH] = legend([c,b],label1,label2,'Position',[0.71 0.6 0.08 0.033]);
set(findobj(objH(5)),'Vis','off');
pos = get(objH(2), 'Pos');
set(objH(2), 'Pos', [0.08 pos(2:3)]);
...
[~, objH] = legend([c,b],label1,label2,'Position',[0.71 0.15 0.08 0.033]);
set(findobj(objH(5)),'Vis','off');
pos = get(objH(2), 'Pos');
set(objH(2), 'Pos', [0.08 pos(2:3)]);
...
[~, objH] = legend([c,b],label1,label2,'Position',[0.28 0.15 0.08 0.033]);
set(findobj(objH(5)),'Vis','off');
pos = get(objH(2), 'Pos');
set(objH(2), 'Pos', [0.08 pos(2:3)]);
