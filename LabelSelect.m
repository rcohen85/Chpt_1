...
% clicks (zID_from_bin_clusters). "data" struct generated by catCTbins
% should be in same directory as _predLab files
% OUTPUT: labFlag matrix consisting of two columns:
...
dataMat = 'HAT_B_01-03_BinsbyLabel'; % name of file containing "data" struct generated by catCTbins
...
for iA = 1:length(clasFiles) %for each toClassify file
    ...
    saveName = strrep(clasFiles(iA).name,'toClassify','labFlag');
