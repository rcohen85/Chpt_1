...
% are excluded from the "flagMat" struct

% clearvars

% directory containing toClassify files
clasDir = 'F:\NFC_A_02\NEW_ClusterBins_120dB\ToClassify';
suffix = '_clusters_PR95_PPmin120_toClassify.mat';
% directory containing label files 
labDir = 'F:\NFC_A_02\NEW_ClusterBins_120dB\ToClassify\labels';
% dataMat = 'WAT_WC_02_BinsbyLabel_Thresh0'; % name of file containing "flagMat" struct generated by catCTbins
% load(fullfile(labDir,dataMat));
% directory to save "data" struct and plots
savDir = 'F:\NFC_A_02\NEW_ClusterBins_120dB\ToClassify\labels';
% saveName = 'NFC_A_03_BinsbyLabel_Thresh0'; % file name for saving "flagMat" struct
...
for i = 1:N %for each CT, determine which labels to keep and which to flag
    ...
    e = input('Enter to save and continue to next plot');
