...
% frequency, on which you must choose the bins you want to use by clicking
...
type = 1; % ****UPDATE ME**** row number of interest in "data" matrix
outDir = 'I:\NNet_TrainTest\New_Cluster_NNet\Set_w_Combos_HighAmp\HFA_50kHz';
saveName = 'NFC_A_03_50kHzSonar';
